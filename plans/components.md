...
- [x] **Raspberry Pi 2 Model B+:** The brains for OpenCV and logic
  ...
  - [x] **VL53L0X Time of Flight Sensors:** 4x, to find distance to edges
  ...
  - [ ] **RGB LED:** 2x, for visual status codes
- [x] **Arduino MEGA R3 2560**: Generates PWM signals to control motor drivers, communicates over serial
  ...
  - [ ] **SENSELIGHT 5V v1 (TRIS10) Colour Sensors:** 4x, to detect field boundaries
